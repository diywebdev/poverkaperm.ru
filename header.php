		...
		<div class="container">
			<div class="flex items-center justify-between h-[50px] lg:h-auto">
				...
				<div class="flex items-center gap-4">
					<?php if(PHONES): ?>
					<a href="tel:<?= formatPhoneLink(PHONES[0]['numbers'][0]['phone']); ?>" class="header__phone text-sm font-bold flex items-center gap-1">
						...
						<span class="hidden sm:block"><?= PHONES[0]['numbers'][0]['phone']; ?></span>
					</a>
					<?php endif; ?>
